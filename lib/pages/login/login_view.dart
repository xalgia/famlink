...
class LoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final homeserver = Matrix.of(context).getLoginClient().homeserver.toString().replaceFirst('https://', '');
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: controller.loading ? const LinearProgressIndicator() : Text(L10n.of(context)!.login),
                ),
              ),
              const SizedBox(height: 16),
              Padding(
