...
class DashboardList extends StatefulWidget {
  ...
  @override
  DashboardListController createState() => DashboardListController();
}

class DashboardListController extends State<DashboardList>
  ...
  void setServer() async {
    ...
    Matrix
        .of(context)
        .store
        .setString(_serverStoreNamespace, newServer.single);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return DashBoardListViewFactor(this);
...
class ChatListController extends State<ChatList>
  ...
  void addChatAction() async {
    if (activeSpaceId == null) {
      context.go('/dashboard/rooms/newprivatechat');
      return;
    }
